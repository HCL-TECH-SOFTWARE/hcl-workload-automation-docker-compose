...
- hclcr.io/wa/hcl-workload-automation-agent-zcentric:9.5.0.07.20240327
...
To start the container from the command-line, launch the following command by adding the name of the image that has been loaded:
    ...
    docker run \
      ...
      hcl-workload-automation-agent-zcentric:9.5.0.07.20240327
...
> \
> After launching the docker load command, you can see the name of the loaded image that should be defined either in the *docker run* command or in the *docker-compose.yml* file to start the container. For further information, see the Configuration Variables section.
...
The Dockerfile and associated scripts are licensed under the [Apache License 2.0](http://www.apache.org/licenses/LICENSE-2.0). HCL Workload Automation is licensed under the HCL International Program License Agreement. This license for HCL Workload Automation Agent can be found [online](https://www.hcl-software.com/resources/master-agreements). Note that this license does not permit further distribution.
